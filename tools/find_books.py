...
class FindBooksTool(Tool):
    def _invoke(self, tool_parameters: dict[str, Any]) -> Generator[ToolInvokeMessage]:
        ...
        try:
            ...
            yield from emit_variable_messages(self, collection_error("books", str(exc), include_total=True))
            return
